...
const cart_item_entity_1 = require("../../models/cart_items/cart_item.entity");
...
__decorate([
    (0, typeorm_1.Column)({ name: "user_id", type: "varchar", unique: true })
...
__decorate([
    (0, typeorm_1.OneToOne)(() => users_entity_1.UserEntity, { onDelete: "CASCADE" }),
